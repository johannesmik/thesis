...
if scene == 'SpecularSphere':
    ...
    normal_image = Image.open("../assets/clustering/SpecularSphere_normal.tiff")
...
estimate.plot_inertias_ratio(inertias, ratios, minmax=(1,20), threshold=0.8)
